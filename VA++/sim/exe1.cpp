...
int main()
{
    ...
    // Load an image
    std::string fn = "../sim/L.png"; float im_scale_default = 0.3f;
    //std::string fn = "../sim/bike256.png"; float im_scale_default = 1.0f;
    ...
    float img_sz = conf.getFloat ("image_scale", im_scale_default);
    ...
    while (v.readyToFinish == false) {
        ...
        if (loop >= 10000) { v.readyToFinish = true; }
    }
